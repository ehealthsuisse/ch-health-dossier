...
Alias: $healthDossierRole = urn:oid:2.16.756.5.30.1.127.3.10.19
...
Alias: $ch-core-relatedperson = http://fhir.ch/ig/ch-core/StructureDefinition/ch-core-relatedperson
Alias: $ch-epr-fhir-humanname = http://fhir.ch/ig/ch-health-dossier/StructureDefinition/ch-epr-fhir-humanname
Alias: $ch-epr-fhir-birthname = http://fhir.ch/ig/ch-health-dossier/StructureDefinition/ch-epr-fhir-birthname
Alias: $ch-ext-deletionstatus = http://fhir.ch/ig/ch-health-dossier/StructureDefinition/ch-ext-deletionstatus
Alias: $ch-ext-patient-religion = http://hl7.org/fhir/StructureDefinition/patient-religion
Alias: $ch-ext-author-authorrole = http://fhir.ch/ig/ch-health-dossier/StructureDefinition/ch-ext-author-authorrole
Alias: $IHE.MHD.UniqueIdIdentifier = https://profiles.ihe.net/ITI/MHD/StructureDefinition/IHE.MHD.UniqueIdIdentifier
Alias: $IHE.MHD.FindDocumentReferencesResponseMessage = https://profiles.ihe.net/ITI/MHD/StructureDefinition/IHE.MHD.FindDocumentReferencesResponseMessage
Alias: $IHE.MHD.Minimal.ProvideBundle = https://profiles.ihe.net/ITI/MHD/StructureDefinition/IHE.MHD.Minimal.ProvideBundle
Alias: $IHE.MHD.Minimal.SubmissionSet = https://profiles.ihe.net/ITI/MHD/StructureDefinition/IHE.MHD.Minimal.SubmissionSet
...
Alias: $ch-mhd-submissionset = http://fhir.ch/ig/ch-health-dossier/StructureDefinition/ch-mhd-submissionset
Alias: $ch-mhd-documentreference = http://fhir.ch/ig/ch-health-dossier/StructureDefinition/ch-mhd-documentreference
